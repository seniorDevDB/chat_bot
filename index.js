  ...
  if (webhook_events.messaging) {
    ...
    webhook_events.messaging.forEach(event => {      
      ...
      if (message && message.quick_reply && message.quick_reply.payload == 'pass_to_inbox') {
        ...
        text = 'The Primary Receiver is passing control to the client. \n\n Tap "Back to Bot" to have the Primary Receiver take control back.';
        title = 'Back to Bot';
        ...
        // default
        text = 'Welcome! The bot is currently in control.\n\n www.goodyear.com \n\n  https://www.goodyeartirerebates.com \n\n Tap "Talk to Client" to chat with client.';
        title = 'Talk to Client';
        payload = 'pass_to_inbox';
